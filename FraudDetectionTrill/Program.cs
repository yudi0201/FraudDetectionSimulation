...
namespace FraudDetectionTrill
{
    class Program
    {
        ...
        class MyObservable : IObservable<TransactionRecord>
        {
            ...
            {
                using (var reader = new StreamReader(@"/root/FraudDetectionSimulation/data/frauddetection/synthetic_txn_data_1_million_UNIX.csv"))
                //using (var reader = new StreamReader(@"C:\Users\yudis\Documents\university\Summer2021\Code\FraudDetectionSimulation\data\frauddetection\synthetic_txn_data_1_thousand_UNIX.csv"))
